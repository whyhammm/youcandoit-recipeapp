...
class RecipeInput extends Component {
  ...
  render() {
    const {title, category, instructions, img, ingredients} = this.state;
      ...
      <div className="recipe-form-container">
        <form className="recipe-form" onSubmit={this.handleSubmit}>
          ...
          <div className="recipe-form-line">
            ...
            <input type="file" id="img" name="recipePicture" placeholder="Enter Picture.." onChange={this.handleChange} value={img} />
          </div>
